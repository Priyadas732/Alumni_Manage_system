    ...
    <>
      ...
      <div className="mt-auto pt-margin border-t border-outline-variant/30">
        <button
          ...
          className="w-full flex items-center gap-md text-on-surface-variant hover:bg-error/10 hover:text-error rounded-lg px-md py-sm transition-all duration-200"
        >
